...
export enum eContractid {
  ...
  HTokensAndRatesHelper = 'HTokensAndRatesHelper',
...
export enum ProtocolErrors {
  ...
  LPC_INVALID_HTOKEN_POOL_ADDRESS = '35', // 'The liquidity of the reserve needs to be 0'
  ...
  LP_CALLER_MUST_BE_AN_HTOKEN = '63',
...
export type iMaticPoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  'DAI' | 'USDC' | 'USDT' | 'WBTC' | 'WETH' | 'WMATIC' | 'HOPE'
>;
...
export type iAvalanchePoolAssets<T> = Pick<
  iAssetsWithoutUSD<T>,
  'WETH' | 'DAI' | 'USDC' | 'USDT' | 'HOPE' | 'WBTC' | 'AVAX'
>;

export type iMultiPoolsAssets<T> = iAssetCommon<T> | iHopeLendPoolAssets<T>;

export type iHopeLendPoolTokens<T> = Omit<iHopeLendPoolAssets<T>, 'ETH'>;
...
export interface iParamsPerPool<T> {
  [HopeLendPools.proto]: T;
  [HopeLendPools.matic]: T;
  [HopeLendPools.amm]: T;
  [HopeLendPools.avalanche]: T;
}
...
export interface IBaseConfiguration {
  ...
  FeeToVault: iParamsPerNetwork<tEthereumAddress>;
}
...
export interface PoolTokens {
  hTokenAddress: tEthereumAddress;
