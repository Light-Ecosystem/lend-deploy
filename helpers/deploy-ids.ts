...
export const ATOKEN_IMPL_ID = `HToken-${MARKET_NAME}`;
export const DELEGATION_AWARE_ATOKEN_IMPL_ID = `DelegationAwareHToken-${MARKET_NAME}`;
...
export const ORACLE_ID = `HopeLendOracle-${MARKET_NAME}`;
...
export const ATOKEN_PREFIX = `-HToken-${MARKET_NAME}`;
