...
export const deployHopeLendProtocolDataProvider = async (
  addressesProvider: tEthereumAddress
) =>
  deployContract<HopeLendProtocolDataProvider>("HopeLendProtocolDataProvider", [
    addressesProvider,
  ]);
...
export const deployDelegationAwareHToken = async ([
  poolAddress,
  underlyingAssetAddress,
  treasuryAddress,
  incentivesController,
  ...
  const instance = await deployContract<DelegationAwareHToken>(
    "DelegationAwareHToken",
    [poolAddress]
  );
...
export const deployDelegationAwareHTokenImpl = async (
  poolAddress: tEthereumAddress
) =>
  deployContract<DelegationAwareHToken>("DelegationAwareHToken", [poolAddress]);
