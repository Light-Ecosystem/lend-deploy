...
export default {
  ...
  dependencyCompiler: {
    paths: [
      ...
      "lend-periphery/contracts/misc/UiIncentiveDataProvider.sol",
      "lend-periphery/contracts/rewards/RewardsController.sol",
      "lend-periphery/contracts/rewards/transfer-strategies/PullRewardsTransferStrategy.sol",
      "lend-periphery/contracts/rewards/EmissionManager.sol",
