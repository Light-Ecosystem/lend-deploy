import { eAvalancheNetwork, IHopeLendConfiguration } from "./../../helpers/types";
import { HopeLendMarket } from "../hopeLend/index";
...
export const AvalancheMarket: IHopeLendConfiguration = {
  ...HopeLendMarket,
  ProviderId: 32,
  WrappedNativeTokenSymbol: "WAVAX",
  MarketId: "Avalanche HopeLend Market",
  HTokenNamePrefix: "Avalanche",
  ...
  ReserveAssets: {
    [eAvalancheNetwork.avalanche]: {
      ...
      HOPE: "0x63a72806098Bd3D9520cC43356dD78afe5D386D9",
  ...
  ChainlinkAggregator: {
    [eAvalancheNetwork.avalanche]: {
      ...
      HOPE: "0x3CA13391E9fb38a75330fb28f8cc2eB3D9ceceED",
