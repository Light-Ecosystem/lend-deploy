import { eFantomNetwork, IHopeLendConfiguration } from "../../helpers/types";
...
export const FantomMarket: IHopeLendConfiguration = {
  ...HopeLendMarket,
  ProviderId: 33,
  WrappedNativeTokenSymbol: "WFTM",
  MarketId: "Fantom HopeLend Market",
  HTokenNamePrefix: "Fantom",
  ...
  ReserveAssets: {
    [eFantomNetwork.main]: {
      ...
      HOPE: "0x6a07A792ab2965C72a5B8088d3a069A7aC3a993B",
  ...
  ChainlinkAggregator: {
    [eFantomNetwork.main]: {
      HOPE: "0xE6ecF7d2361B6459cBb3b4fb065E0eF4B175Fe74",
