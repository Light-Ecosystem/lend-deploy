import { eHarmonyNetwork, IHopeLendConfiguration } from "../../helpers/types";
...
export const HarmonyMarket: IHopeLendConfiguration = {
  ...HopeLendMarket,
  ProviderId: 31,
  WrappedNativeTokenSymbol: "WONE",
  MarketId: "Harmony HopeLend Market",
  HTokenNamePrefix: "Harmony",
  ...
  ReserveAssets: {
    [eHarmonyNetwork.main]: {
      ...
      HOPE: "0xcF323Aad9E522B93F11c352CaA519Ad0E14eB40F",
  ...
  ChainlinkAggregator: {
    [eHarmonyNetwork.main]: {
      ...
      HOPE: "0x6EE1EfCCe688D5B79CB8a400870AF471c5282992",
    },
  },
  EModes: {
    StableEMode: {
