...
import { PERIPHERY_VERSION } from "../../helpers/constants";
import {
 ...
 * following the IncentivesController interface to be compatible with HTokens or Debt Tokens.
 */
...
func.id = `Incentives:${MARKET_NAME}:lend-periphery@${PERIPHERY_VERSION}`;
